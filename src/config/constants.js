...
export const LOZENGE_MIN_HEIGHT = 4;
export const LOZENGE_MAX_HEIGHT = 20;

// Fixed height for individual (non-binned) flow lozenges
export const LOZENGE_INDIVIDUAL_HEIGHT = 6;
